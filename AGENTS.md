...
<!-- workspace-tools:begin -->
## Google Workspace tooling (UC Berkeley)

Controller repo: `~/tools/google-workspace-tools`. This project is bound to **UC Berkeley** (`berkeley.edu`) only.

- Runbook: [docs/GOOGLE_ACCOUNTS_AND_TOOLING.md](file:///Users/me/tools/google-workspace-tools/docs/GOOGLE_ACCOUNTS_AND_TOOLING.md)
- Cursor rule: `.cursor/rules/berkeley-google-workspace.mdc` (auto-generated by `just attach-project`)
- Manifest: `.workspace-tools.json`
- Isolation policy: [org-isolation-policy.md](file:///Users/me/tools/google-workspace-tools/docs/org-isolation-policy.md)
...
- **Intentional override:** user must say so explicitly (`cross-org override: …` or `I know this is UC Berkeley; still use [other org]`).
<!-- workspace-tools:end -->
