...
- [ ] **REPO + DATAHUB - top priority, this blocks students from cloning.** The 2026 materials live in `evictionresearch/SOC-N100-Housing-Precarity-2026`, which is **PRIVATE**. Every DataHub/clone link points to the year-less name, which GitHub now redirects to `SOC-N100-Housing-Precarity-2025` (last year's PUBLIC repo). So today the links pull 2025, and DataHub git-pull needs a public repo.
